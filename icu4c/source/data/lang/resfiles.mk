...
LANG_SOURCE = af.txt agq.txt ak.txt am.txt\
 ...
 asa.txt az.txt az_Cyrl.txt az_Cyrl_AZ.txt az_Latn.txt\
 bas.txt be.txt bem.txt bez.txt bg.txt\
 bm.txt bm_Latn.txt bn.txt bn_IN.txt bo.txt\
 ...
 en_MY.txt en_NA.txt en_NF.txt en_NG.txt en_NR.txt\
 ...
 ne.txt ne_IN.txt nl.txt nl_BE.txt nmg.txt\
 nn.txt nnh.txt nus.txt nyn.txt om.txt\
 or.txt os.txt pa.txt pa_Arab.txt pa_Arab_PK.txt\
