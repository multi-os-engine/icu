...
public final class BodyDeclarationLocaters {
  ...
  private static int getDeclarationNodeType(String bodyDeclarationTypeString) {
    ...
    if (nodeType == null) {
      throw new IllegalArgumentException("Unsupported node type string: " + bodyDeclarationTypeString);
    }
    return nodeType;
  }
  ...
  private static String createName(BodyDeclaration bodyDeclaration) {
    if (bodyDeclaration instanceof AbstractTypeDeclaration) {
      ...
      if (abstractTypeDeclaration.isPackageMemberTypeDeclaration()) {
        ...
        return cu.getPackage().getName().getFullyQualifiedName() + "." + abstractTypeDeclaration.getName().getFullyQualifiedName();
      }
    }
    ...
    switch (bodyDeclaration.getNodeType()) {
      ...
      case ASTNode.ENUM_DECLARATION: {
        ...
        AbstractTypeDeclaration parentType = (AbstractTypeDeclaration) nestedTypeDeclaration
            .getParent();
