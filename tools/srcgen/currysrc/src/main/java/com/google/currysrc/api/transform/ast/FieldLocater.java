...
/**
 * Locates the {@link org.eclipse.jdt.core.dom.BodyDeclaration} associated with an field declaration.
 */
public final class FieldLocater implements BodyDeclarationLocater {
    ...
    public boolean matches(BodyDeclaration node) {
        if (node instanceof FieldDeclaration) {
            ...
            for (VariableDeclarationFragment variableDeclarationFragment : (List<VariableDeclarationFragment>) fieldDeclaration.fragments()) {
