...
public class MungeIcuJavaDocTags implements DocumentTransformer {
  ...
  /** The set of problem tags. The pattern contains two groups: one for the "@", one for the tag. */
  private final static Pattern PATTERN =
      Pattern.compile("(@)(icu|internal|draft|provisional|icuenhanced|icunote|\\.jcite|obsolete)");
