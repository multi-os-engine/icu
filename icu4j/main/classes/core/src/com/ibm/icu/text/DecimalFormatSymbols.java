...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    */
    ...
    private void initialize( ULocale locale ) {
        // Begin Google-specific change, cf. NumberFormat.getPattern().
        final String numbers = locale.getKeywordValue("numbers");
        // TODO(roozbeh): remove this when all users of 'local' were replaced with 'native'
        if ("local".equals(numbers)) {
            locale = locale.setKeywordValue("numbers", null);
        ...
        } else if (numbers == null && "ar".equals(locale.getLanguage())) {
