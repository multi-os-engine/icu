...
//          }
    ...
    protected static String getPattern(ULocale forLocale, int choice) {
        // Begin Google-specific change, cf. DecimalFormatSymbols.initialize().
        final String numbers = forLocale.getKeywordValue("numbers");
        // TODO(roozbeh): remove this when all users of 'local' were replaced with 'native'
        if ("local".equals(numbers)) {
            forLocale = forLocale.setKeywordValue("numbers", null);
        // Temporarily keep Arabic using ASCII digits, to minimize disruption
        // TODO(roozbeh): remove this hack when native numbers were tested across a few products
        } else if (numbers == null && "ar".equals(forLocale.getLanguage())) {
            forLocale = forLocale.setKeywordValue("numbers", "latn");
        }
