...
public class NumberFormatTest extends com.ibm.icu.dev.test.TestFmwk {
    ...
    public void TestCurrencyIsoPluralFormat() {
        String[][] DATA = {
                ...
                // Google uses latn digits by default
                // old arabic digits \u0661\u066B\u0660\u0660
                // Begin Google-specific change (http://b/5014638)
                {"ar_EG", "1", "USD", "US$\u00A01.00", "USD\u00a01.00", "1.00 \u062f\u0648\u0644\u0627\u0631 \u0623\u0645\u0631\u064a\u0643\u064a"},
	...
	// 'Rs.' is used at Google, at least for now
    ...
    public void TestNumberingSystems() {
        ...
        final TestNumberingSystemItem[] DATA = {
                ...
                // Begin Google Patch
                // ar_EG default numbering system.
                new TestNumberingSystemItem( "ar_EG@numbers=foobar",      1234.567, false, "\u0661\u066c\u0662\u0663\u0664\u066b\u0665\u0666\u0667" ),
                // fa_IR default numbering system
                new TestNumberingSystemItem( "fa_IR",                     1234.567, false, "\u06f1\u066c\u06f2\u06f3\u06f4\u066b\u06f5\u06f6\u06f7" ),
                // Begin Google-specific change (http://b/5014638)
                new TestNumberingSystemItem( "ar_EG",                     1234.567, false, "1,234.567" ),
                // End Google Patch
    ...
    public void TestParseSignsAndMarks() {
        ...
        final SignsAndMarksItem[] items = {
            ...
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("en",                 true,   "- 23",                                 -23 ), // ***
            new SignsAndMarksItem("en",                 false,  "\u200E-23",                            -23 ),
            new SignsAndMarksItem("en",                 true,   "\u200E-23",                            -23 ),
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("en",                 true,   "\u200E- 23",                           -23 ), // ***
            ...
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("he",                 true,   "- 23",                                 -23 ), // ***
            new SignsAndMarksItem("he",                 false,  "\u200E-23",                            -23 ),
            new SignsAndMarksItem("he",                 true,   "\u200E-23",                            -23 ),
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("he",                 true,   "\u200E- 23",                           -23 ), // ***
            ...
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("ar",                 true,   "- \u0664\u0665",                       -45 ), // ***
            new SignsAndMarksItem("ar",                 false,  "\u200F-\u0664\u0665",                  -45 ),
            new SignsAndMarksItem("ar",                 true,   "\u200F-\u0664\u0665",                  -45 ),
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("ar",                 true,   "\u200F- \u0664\u0665",                 -45 ), // ***
            ...
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("ar_MA",              true,   "- 23",                                 -23 ), // ***
            new SignsAndMarksItem("ar_MA",              false,  "\u200E-23",                            -23 ),
            new SignsAndMarksItem("ar_MA",              true,   "\u200E-23",                            -23 ),
            // GOOGLE(ask Markus how to fix) new SignsAndMarksItem("ar_MA",              true,   "\u200E- 23",                           -23 ), // ***
