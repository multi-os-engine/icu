    ...
    private void TestGetUnicodeSet(DataMap testcase) {
        ...
        try{
           ...
           try{
               ...
               // Start of Google-specific patch.  Our ISO2022 data is different from the
               // public ICU data, so the test of this charset fails.
               if (cc.charset.equals("JIS7")) {
                   logln("Charset test not supported: " + cc.charset + " (" + charset.name() + ")");
                   return;
               }
               // End of Google-specific patch
